...
- `POST /api/v1/translations`: read a ready cached translation for a public question, answer, or answer response, return original content when `source_language == target_language`, or enqueue a missing translation for a logged-in caller. Anonymous callers never trigger provider work.
